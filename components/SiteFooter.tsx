  ...
  return (
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-6xl mx-auto px-4 py-12 grid gap-8 md:grid-cols-3">
        <div>
          <h3 className="text-white font-semibold text-lg mb-3">Kalyan Gold Fund</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-slate-400">
            <li>Email: support@kalyanGoldFund.com</li>
      ...
      <div className="border-t border-slate-800 py-4 text-center text-xs text-slate-500">
        © {new Date().getFullYear()} Kalyan Gold Fund. All rights reserved.
      </div>
    </footer>
  );
}
